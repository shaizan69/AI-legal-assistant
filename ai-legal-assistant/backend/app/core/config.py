...
class Settings(BaseSettings):
    ...
    def __init__(self, **kwargs):
        ...
        try:
            print(f"[config] GEMINI_MODEL loaded: {self.GEMINI_MODEL}")
            print(f"[config] GEMINI_API_KEY loaded: {self.GEMINI_API_KEY[:10]}...")
        except Exception as e:
            print(f"[config] Error logging Gemini info: {e}")
