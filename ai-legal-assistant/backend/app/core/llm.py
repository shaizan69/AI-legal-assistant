"""
Large Language Model wrapper and utilities using Mistral 7B with Ollama (primary)
"""
...
from app.core.mistral_llm import MistralLLMService

logger = logging.getLogger(__name__)


class LLMService:
    """Service for interacting with Large Language Models via Ollama (Mistral 7B)"""

    def __init__(self):
        # Use Mistral service as primary and only provider
        self.mistral_service = MistralLLMService()

    async def generate_text(self, prompt: str, max_tokens: int = 1000, temperature: float = 0.7) -> str:
        """Generate text using the Mistral LLM"""
        return await self.mistral_service.generate_text(prompt, max_tokens, temperature)
    ...
    async def summarize_document(self, text: str, document_type: str = "contract") -> Dict[str, Any]:
        ...
        return await self.mistral_service.summarize_document(text, document_type)
    ...
    async def detect_risks(self, text: str, document_type: str = "contract") -> Dict[str, Any]:
        ...
        return await self.mistral_service.detect_risks(text, document_type)
    ...
    async def compare_documents(self, doc1_text: str, doc2_text: str, doc1_type: str = "contract", doc2_type: str = "contract") -> Dict[str, Any]:
        ...
        return await self.mistral_service.compare_documents(doc1_text, doc2_text, doc1_type, doc2_type)
    ...
    async def answer_question(self, question: str, context: str) -> Dict[str, Any]:
        ...
        return await self.mistral_service.answer_question(question, context)
